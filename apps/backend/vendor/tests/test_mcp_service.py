...
from vendor.api.v1.schemas import ConnectMCPServerRequest, GrantTenantResourceRequest
...
def test_add_mcp_server_request_resolves_sources():
    from vendor.api.v1.schemas import AddMCPServerRequest
...
async def test_mcp_connection_self_heals_go_stdio_args(db, monkeypatch):
    ...
    import vendor.services.mcp_service as ms
    ...
    monkeypatch.setattr("vendor.services.mcp_service.MCPClient.connect", _fake_connect)
